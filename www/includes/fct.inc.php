...
function estConnecte() {
    return isset($_SESSION['id']); //isset fonction qui retourne si oui ou non dans la variable session la colonne id est remplit 
}
...
/**
 * Enregistre dans une variable session les infos d'un visiteur/comptable
 *
...
function connecter($id, $nom, $prenom, $statut) {
    $_SESSION['id'] = $id; // dans la colonne id de la superglobale session on met la variable $id
    $_SESSION['nom'] = $nom;
...
function ajouterErreur($msg) {
    if (!isset($_REQUEST['erreurs'])) {//isset c'est est ce que ça contient quelquechose
        $_REQUEST['erreurs'] = array(); //superglobale request ne contient pas erreurs 
    }
