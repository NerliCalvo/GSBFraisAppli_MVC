...
class PdoGsb {
     ...
     */
    private function __construct() { //initialise toutes les variables qui n'ont pas été déclarées
     ...
     */
    public function __destruct() { // il détruit la variable PdoGsb pour libérer la place
        PdoGsb::$monPdo = null;
    }
     ...
     */
    public static function getPdoGsb() { // crée l'unique objet (instance) de la classe qui est monPdoGsb
    ...
    public function getTotalFraisHorsForfait($visiteur, $mois) {
        $requetePrepare = PdoGsb::$monPdo->prepare(
